...
<div class="mb-8">
    <div class="flex items-center gap-2 text-sm text-slate-500 mb-2">
        ...
        <span>/</span>
        <span class="text-slate-900 font-medium">Edit Misi</span>
    </div>
    <h1 class="text-2xl md:text-3xl font-bold text-slate-900">Ubah Data Misi</h1>
    <p class="text-slate-500 mt-1">Perbarui urutan dan penjelasan dari poin misi.</p>
</div>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="konten" id="konten" rows="5" required
                          class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-green-600 focus:border-transparent outline-none transition-all">{{ old('konten', $misi->konten) }}</textarea>
