...
<div class="mb-8">
    <div class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-300 dark:text-white mb-2">
        ...
        <span>/</span>
        <span class="text-slate-900 dark:text-white font-medium">Tambah Misi</span>
    </div>
    <h1 class="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Tambah Poin Misi</h1>
    <p class="text-slate-500 dark:text-slate-300 dark:text-white mt-1">Masukkan urutan dan penjelasan dari poin misi yang ingin ditambahkan.</p>
</div>
