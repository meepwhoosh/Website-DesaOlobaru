...
<div class="mb-8">
    <div class="flex items-center gap-2 text-sm text-slate-500 mb-2">
        ...
        <span>/</span>
        <span class="text-slate-900 font-medium">Tambah Produk</span>
    </div>
    <h1 class="text-2xl md:text-3xl font-bold text-slate-900">Tambah Produk Baru</h1>
    <p class="text-slate-500 mt-1">Masukkan informasi detail mengenai produk UMKM desa.</p>
</div>
