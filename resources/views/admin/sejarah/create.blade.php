...
<div class="mb-8">
    <div class="flex items-center gap-2 text-sm text-slate-500 mb-2">
        ...
        <span>/</span>
        <span class="text-slate-900 font-medium">Tambah Riwayat</span>
    </div>
    <h1 class="text-2xl md:text-3xl font-bold text-slate-900">Catat Sejarah Baru</h1>
    <p class="text-slate-500 mt-1">Tambahkan jejak rekam sejarah pembentukan atau peristiwa penting desa.</p>
</div>
    ...
    <form action="{{ route('admin.sejarah.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 mt-1">Anda bisa mengetikkan paragraf panjang di sini.</p>
