...
<div class="mb-8 flex items-center justify-between">
    <div>
        <h1 class="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Edit Data Penduduk</h1>
        <p class="text-slate-500 dark:text-slate-300 dark:text-white mt-1">Ubah informasi penduduk.</p>
    </div>
    ...
    <form action="{{ route('admin.data-desa.update', $data->id) }}" method="POST" class="p-6 md:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="rt" id="rt" value="{{ old('rt', $data->rt) }}"
                    class="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 focus:border-green-600 focus:ring focus:ring-green-600/20 transition-all outline-none text-slate-700 dark:text-slate-200 dark:bg-slate-800 dark:text-white dark:border-slate-700"
            ...
            <div>
                ...
                <input type="text" name="rw" id="rw" value="{{ old('rw', $data->rw) }}"
                    class="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 focus:border-green-600 focus:ring focus:ring-green-600/20 transition-all outline-none text-slate-700 dark:text-slate-200 dark:bg-slate-800 dark:text-white dark:border-slate-700"
