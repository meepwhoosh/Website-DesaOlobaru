...
<div class="mb-8 flex items-center justify-between">
    <div>
        <h1 class="text-2xl md:text-3xl font-bold text-slate-900">Tulis Berita Baru</h1>
        <p class="text-slate-500 mt-1">Publikasikan informasi atau kegiatan terbaru desa.</p>
    </div>
    ...
    <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8">
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Gambar -->
                <x-admin.image-upload name="gambar" label="Unggah Gambar / Foto Utama" helper="Format: JPG, PNG. Maksimal 2MB. (Opsional)" />
