...
<div class="mb-8 flex items-center justify-between">
    <div>
        <h1 class="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Edit Berita</h1>
        <p class="text-slate-500 dark:text-slate-300 dark:text-white mt-1">Lakukan perubahan pada artikel berita ini.</p>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="konten" id="konten" rows="8" required
                    class="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 focus:border-green-600 focus:ring focus:ring-green-600/20 transition-all outline-none text-slate-700 dark:text-slate-200 dark:bg-slate-800 dark:text-white dark:border-slate-700">{{ old('konten', $berita->konten) }}</textarea>
