...
<div class="mb-8 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Edit Foto Galeri</h1>
        <p class="text-slate-500 dark:text-slate-300 dark:text-white mt-1">Perbarui detail dokumentasi foto.</p>
    </div>
