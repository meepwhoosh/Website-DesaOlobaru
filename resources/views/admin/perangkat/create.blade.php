...
<div class="mb-8 flex items-center justify-between">
    <div>
        <h1 class="text-2xl md:text-3xl font-bold text-slate-900">Tambah Anggota Baru</h1>
        <p class="text-slate-500 mt-1">Masukkan data aparatur desa atau anggota BPD.</p>
    </div>
