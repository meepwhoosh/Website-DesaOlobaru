...
<div class="mb-8">
    <div class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-300 dark:text-white mb-2">
        ...
        <span>/</span>
        <span class="text-slate-900 dark:text-white font-medium">Edit Data</span>
    </div>
    <h1 class="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Ubah Data Destinasi</h1>
    <p class="text-slate-500 dark:text-slate-300 dark:text-white mt-1">Perbarui informasi tempat wisata atau potensi alam desa.</p>
</div>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="deskripsi" id="deskripsi" rows="4" 
                          class="w-full px-4 py-2 bg-slate-50 dark:bg-[#0f0f0f] dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-green-600 focus:border-transparent outline-none transition-all">{{ old('deskripsi', $wisata->deskripsi) }}</textarea>
