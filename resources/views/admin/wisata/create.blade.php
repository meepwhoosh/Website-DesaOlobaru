...
<div class="mb-8">
    <div class="flex items-center gap-2 text-sm text-slate-500 mb-2">
        ...
        <span>/</span>
        <span class="text-slate-900 font-medium">Tambah Data</span>
    </div>
    <h1 class="text-2xl md:text-3xl font-bold text-slate-900">Tambah Destinasi Baru</h1>
    <p class="text-slate-500 mt-1">Masukkan informasi detail mengenai tempat wisata atau potensi alam desa.</p>
</div>
...
<div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden max-w-4xl">
    <form action="{{ route('admin.wisata.store') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-6">
        ...
        <div class="space-y-4">
            ...
            <x-admin.image-upload name="gambar" label="Foto Tempat Wisata" helper="PNG, JPG, GIF up to 2MB (Gunakan gambar pemandangan lanskap (lebar))" />
        </div>
